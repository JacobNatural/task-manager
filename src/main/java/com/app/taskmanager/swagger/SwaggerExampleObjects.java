package com.app.taskmanager.swagger;

public class SwaggerExampleObjects {

    public static final String TASK_FILTER_DTO = """
            {
              "filterCriteria": [
                { "key": "status", "value": "TO_DO", "operation": "IS" }
              ]
            }
            """;

    public static final String USER_FILTER_DTO = """
            {
              "filterCriteria": [
                { "key": "username", "value": "^Sky.*", "operation": "REGEX" }
              ]
            }
            """;
